...
class Loop2010Bd(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2010BdRefSegment]] = Field(default=None, max_length=2)
...
class Loop2305(X12SegmentGroup):
    ...
    hsd_segment: Optional[List[Loop2305HsdSegment]] = Field(default=None, max_length=3)
...
class Loop2330B(X12SegmentGroup):
    ...
    per_segment: Optional[List[Loop2330BPerSegment]] = Field(default=None, max_length=2)
    dtp_segment: Optional[Loop2330BDtpSegment] = None
    ref_segment: Optional[List[Loop2300BRefSegment]] = Field(default=None, max_length=6)
...
class Loop2310E(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2310ERefSegment]] = Field(default=None, max_length=5)
...
class Loop2310C(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2310CRefSegment]] = Field(default=None, max_length=3)
...
class Loop2310B(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2310BRefSegment]] = Field(default=None, max_length=4)
...
class Loop2420F(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2420FRefSegment]] = Field(default=None, max_length=5)
...
class Loop2420E(X12SegmentGroup):
    ...
    n3_segment: Optional[N3Segment] = None
    n4_segment: Optional[N4Segment] = None
    ref_segment: Optional[List[Loop2420ERefSegment]] = Field(default=None, max_length=5)
...
class Loop2420D(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2420DRefSegment]] = Field(default=None, max_length=5)
...
class Loop2400(X12SegmentGroup):
    ...
    cr2_segment: Optional[List[Cr2Segment]] = Field(default=None, max_length=5)
    cr3_segment: Optional[Cr3Segment] = None
    cr5_segment: Optional[Cr5Segment] = None
    crc_segment: Optional[List[Loop2400CrcSegment]] = Field(default=None, max_length=10)
    dtp_segment: List[Loop2400DtpSegment] = Field(min_length=1, max_length=20)
    mea_segment: Optional[List[MeaSegment]] = Field(default=None, max_length=20)
    cn1_segment: Optional[Loop2400Cn1Segment] = None
    ref_segment: Optional[List[Loop2400RefSegment]] = Field(default=None, max_length=15)
    amt_segment: Optional[List[Loop2400AmtSegment]] = Field(default=None, max_length=3)
...
class Loop2300(X12SegmentGroup):
    ...
    dtp_segment: Optional[List[Loop2300DtpSegment]] = Field(default=None, min_length=0, max_length=17)
    ...
    amt_segment: Optional[List[Loop2300AmtSegment]] = Field(default=None, max_length=3)
    ref_segment: Optional[List[Loop2300RefSegment]] = Field(default=None, min_length=0, max_length=14)
    ...
    crc_segment: Optional[List[Loop2300CrcSegment]] = Field(default=None, min_length=0, max_length=8)
    hi_segment: Optional[List[HiSegment]] = Field(default=None, min_length=1, max_length=4)
    hcp_segment: Optional[HcpSegment] = None
