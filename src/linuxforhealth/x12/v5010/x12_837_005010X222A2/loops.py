...
class Loop2320(X12SegmentGroup):
    ...
    amt_segment: Optional[List[AmtSegment]] = Field(default=None, min_length=0, max_length=3)
...
class Loop2310A(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2310ARefSegment]] = Field(default=None, min_length=0, max_length=3)
...
class Loop2430(X12SegmentGroup):
    ...
    cas_segment: Optional[List[CasSegment]] = Field(default=None, )
...
class Loop2420F(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2420FRefSegment]] = Field(default=None, min_length=0, max_length=20)
...
class Loop2420E(X12SegmentGroup):
    ...
    n3_segment: Optional[N3Segment] = None
    n4_segment: Optional[N4Segment] = None
    ref_segment: Optional[List[Loop2420ERefSegment]] = Field(default=None, min_length=0, max_length=20)
...
class Loop2420B(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2420BRefSegment]] = Field(default=None, min_length=0, max_length=20)
...
class Loop2400(X12SegmentGroup):
    ...
    crc_segment: Optional[List[Loop2400CrcSegment]] = Field(default=None, min_length=0, max_length=5)
    dtp_segment: List[Loop2400DtpSegment] = Field(min_length=1, max_length=11)
    qty_segment: Optional[List[Loop2400QtySegment]] = Field(default=None, min_length=0, max_length=2)
    mea_segment: Optional[List[MeaSegment]] = Field(default=None, min_length=0, max_length=5)
    cn1_segment: Optional[Loop2400Cn1Segment] = None
    ref_segment: Optional[List[Loop2400RefSegment]] = Field(default=None, min_length=0, max_length=11)
    ...
    nte_segment: Optional[List[Loop2400NteSegment]] = Field(default=None, min_length=0, max_length=2)
