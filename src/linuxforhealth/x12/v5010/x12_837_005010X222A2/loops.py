...
class Loop2010Aa(X12SegmentGroup):
    ...
    per_segment: Optional[List[Loop2010AaPerSegment]] = Field(min_length=0, max_length=2)
...
class Loop2330B(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2300BRefSegment]] = Field(min_length=0, max_length=6)
...
class Loop2320(X12SegmentGroup):
    ...
    amt_segment: Optional[List[AmtSegment]] = Field(min_length=0, max_length=3)
...
class Loop2310C(X12SegmentGroup):
    ...
    n3_segment: N3Segment
    n4_segment: N4Segment
    ref_segment: Optional[List[Loop2310CRefSegment]] = Field(min_length=0, max_length=3)
...
class Loop2310B(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2310BRefSegment]] = Field(min_length=0, max_length=4)
...
class Loop2310A(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2310ARefSegment]] = Field(min_length=0, max_length=3)
...
class Loop2420F(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2420FRefSegment]] = Field(min_length=0, max_length=20)
...
class Loop2420E(X12SegmentGroup):
    ...
    n3_segment: Optional[N3Segment] = None
    n4_segment: Optional[N4Segment] = None
    ref_segment: Optional[List[Loop2420ERefSegment]] = Field(min_length=0, max_length=20)
...
class Loop2420D(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2420DRefSegment]] = Field(min_length=0, max_length=20)
...
class Loop2420C(X12SegmentGroup):
    ...
    n3_segment: N3Segment
    n4_segment: N4Segment
    ref_segment: Optional[List[Loop2420CRefSegment]] = Field(min_length=0, max_length=3)
...
class Loop2420B(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2420BRefSegment]] = Field(min_length=0, max_length=20)
...
class Loop2420A(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2420ARefSegment]] = Field(min_length=0, max_length=20)
...
class Loop2400(X12SegmentGroup):
    ...
    crc_segment: Optional[List[Loop2400CrcSegment]] = Field(min_length=0, max_length=5)
    dtp_segment: List[Loop2400DtpSegment] = Field(min_length=1, max_length=11)
    qty_segment: Optional[List[Loop2400QtySegment]] = Field(min_length=0, max_length=2)
    mea_segment: Optional[List[MeaSegment]] = Field(min_length=0, max_length=5)
    cn1_segment: Optional[Loop2400Cn1Segment] = None
    ref_segment: Optional[List[Loop2400RefSegment]] = Field(min_length=0, max_length=11)
    amt_segment: Optional[List[Loop2400AmtSegment]] = Field(min_length=0, max_length=2)
    k3_segment: Optional[List[K3Segment]] = Field(min_length=0, max_length=10)
    nte_segment: Optional[List[Loop2400NteSegment]] = Field(min_length=0, max_length=2)
    ...
    loop_2430: Optional[List[Loop2430]] = Field(min_length=0, max_length=15)
    loop_2440: Optional[List[Loop2440]] = Field(min_length=0)
...
class Loop2010Ca(X12SegmentGroup):
    ...
    ref_segment: Optional[List[Loop2010CaRefSegment]] = Field(min_length=0, max_length=2)
